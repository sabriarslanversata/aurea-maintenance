...
namespace Aurea.Maintenance.Debugger.Accent
{
    ...
    public class Program
    {
        public class MyMaintenance : CIS.Clients.Accent.Maintenance
        {
            ...
            public void EnrollCustomers()
            {
                InitializeVariables("Enrollments");
                ...
                try
                {
                    ...
                    EnrollCustomer ec = new EnrollCustomer(ConnectionAdmin, ConnectionCsr, 0);
                    ec.Import();

                    LogMethodExecution((int)MethodOptions.Enrollments, startDate, DateTime.Now);
                }
                catch (Exception ex)
                {
                    Manager.Publish(ex);
...
WHERE
  src.ProductCode IN (SELECT ProductCode FROM saes_Accent..Product WHERE ProductId IN (SELECT ProductID FROM @Products)) AND ActiveDate >= '2017-08-06'
...
DECLARE @SourceId INT = (SELECT RequestId FROM daes_Accent..CustomerTransactionRequest WHERE CustId = @CustId AND TransactionType = '814' AND ActionCode = '05' AND Direction = 1)
DECLARE @EightFourteenKey INT = (SELECT SourceId FROM daes_Accent..CustomerTransactionRequest WHERE CustId = @CustId AND TransactionType = '814' AND ActionCode = '05' AND Direction = 1)
DECLARE @ServiceKey INT = (SELECT Service_Key FROM daes_AccentMarket..tbl_814_Service WHERE [814_Key] = @EightFourteenKey)
DECLARE @MarketFileId INT = (SELECT MarketFileId FROM daes_AccentMarket..tbl_814_Header WHERE [814_Key] = @EightFourteenKey)
DECLARE @MeterKey INT = (SELECT Meter_Key FROM daes_AccentMarket..tbl_814_Service_Meter WHERE Service_Key = @ServiceKey)
...
INSERT INTO daes_AccentMarket..tbl_814_Service(  [814_Key], [AssignId], [ServiceTypeCode1], [ServiceType1], [ServiceTypeCode2], [ServiceType2], [ServiceTypeCode3], [ServiceType3], [ServiceTypeCode4], 
 [ServiceType4], [ActionCode], [MaintenanceTypeCode], [DistributionLossFactorCode], [PremiseType], [BillType], [BillCalculator], [EsiId], [StationId], [SpecialNeedsIndicator], [PowerRegion], [EnergizedFlag], 
 [EsiIdStartDate], [EsiIdEndDate], [EsiIdEligibilityDate], [NotificationWaiver], [SpecialReadSwitchDate], [PriorityCode], [PermitIndicator], [RTODate], [RTOTime], [CSAFlag], [MembershipID], [ESPAccountNumber], 
 [LDCBillingCycle], [LDCBudgetBillingCycle], [WaterHeaters], [LDCBudgetBillingStatus], [PaymentArrangement], [NextMeterReadDate], [ParticipatingInterest], [EligibleLoadPercentage], [TaxExemptionPercent], 
 [CapacityObligation], [TransmissionObligation], [TotalKWHHistory], [NumberOfMonthsHistory], [PeakDemandHistory], [AirConditioners], [PreviousEsiId], [GasPoolId], [LBMPZone], [ResidentialTaxPortion], 
 [ESPCommodityPrice], [ESPFixedCharge], [ESPChargesCommTaxRate], [ESPChargesResTaxRate], [GasSupplyServiceOption], [FundsAuthorization], [BudgetBillingStatus], [FixedMonthlyCharge], [TaxRate], [CommodityPrice], 
 [MeterCycleCodeDesc], [BillCycleCodeDesc], [FeeApprovedApplied], [MarketerCustomerAccountNumber], [GasSupplyServiceOptionCode], [HumanNeeds], [ReinstatementDate], [MeterCycleCode], [SystemNumber], 
 [StateLicenseNumber], [SupplementalAccountNumber], [NewCustomerIndicator], [PaymentCategory], [PreviousESPAccountNumber], [RenewableEnergyIndicator], [SICCode], [ApprovalCodeIndicator], 
 [RenewableEnergyCertification], [NewPremiseIndicator], [SalesResponsibility], [CustomerReferenceNumber], [TransactionReferenceNumber], [ESPTransactionNumber], [OldESPAccountNumber], [DFIIdentificationNumber],
 [DFIAccountNumber], [DFIIndicator1], [DFIIndicator2], [DFIQualifier], [DFIRoutingNumber], [SpecialReadSwitchTime], [CustomerAuthorization], [LDCAccountBalance], [DisputedAmount], [CurrentBalance], [ArrearsBalance], 
 [IntervalStatusType], [LDCSupplierBalance], [BudgetPlan], [BudgetInstallment], [Deposit], [RemainingUtilBalanceBucket1], [RemainingUtilBalanceBucket2], [RemainingUtilBalanceBucket3], [RemainingUtilBalanceBucket4], 
 [RemainingUtilBalanceBucket5], [RemainingUtilBalanceBucket6], [UnmeteredAcct], [PaymentOption], [MaxDailyAmt], [MeterAccessNote], [SpecialNeedsExpirationDate], [SwitchHoldStatusIndicator], [SpecialMeterConfig], 
 [MaximumGeneration], [IgnoreRescind], [ServiceDeliveryPoint], [GasCapacityAssignment], [CPAEnrollmentTypes], [DaysInArrears], [RU_Notes], [RD_SiteCharacterDate], [SupplierPricingStructureNr], [SupplierGroupNumber], 
...
VALUES (
 ...
 NULL/*[ESPFixedCharge]*/, NULL/*[ESPChargesCommTaxRate]*/, NULL/*[ESPChargesResTaxRate]*/, NULL/*[GasSupplyServiceOption]*/, NULL/*[FundsAuthorization]*/, NULL/*[BudgetBillingStatus]*/, NULL/*[FixedMonthlyCharge]*/, 
 NULL/*[TaxRate]*/, NULL/*[CommodityPrice]*/, NULL/*[MeterCycleCodeDesc]*/, NULL/*[BillCycleCodeDesc]*/, NULL/*[FeeApprovedApplied]*/, NULL/*[MarketerCustomerAccountNumber]*/, NULL/*[GasSupplyServiceOptionCode]*/, 
 'N'/*[HumanNeeds]*/, NULL/*[ReinstatementDate]*/, NULL/*[MeterCycleCode]*/, NULL/*[SystemNumber]*/, NULL/*[StateLicenseNumber]*/, NULL/*[SupplementalAccountNumber]*/, NULL/*[NewCustomerIndicator]*/, NULL/*[PaymentCategory]*/, 
 NULL/*[PreviousESPAccountNumber]*/, NULL/*[RenewableEnergyIndicator]*/, NULL/*[SICCode]*/, NULL/*[ApprovalCodeIndicator]*/, NULL/*[RenewableEnergyCertification]*/, NULL/*[NewPremiseIndicator]*/, NULL/*[SalesResponsibility]*/, 
 NULL/*[CustomerReferenceNumber]*/, NULL/*[TransactionReferenceNumber]*/, NULL/*[ESPTransactionNumber]*/, NULL/*[OldESPAccountNumber]*/, NULL/*[DFIIdentificationNumber]*/, NULL/*[DFIAccountNumber]*/, NULL/*[DFIIndicator1]*/, 
 NULL/*[DFIIndicator2]*/, NULL/*[DFIQualifier]*/, NULL/*[DFIRoutingNumber]*/, NULL/*[SpecialReadSwitchTime]*/, NULL/*[CustomerAuthorization]*/, NULL/*[LDCAccountBalance]*/, NULL/*[DisputedAmount]*/, NULL/*[CurrentBalance]*/, 
 NULL/*[ArrearsBalance]*/, NULL/*[IntervalStatusType]*/, NULL/*[LDCSupplierBalance]*/, NULL/*[BudgetPlan]*/, NULL/*[BudgetInstallment]*/, NULL/*[Deposit]*/, NULL/*[RemainingUtilBalanceBucket1]*/, NULL/*[RemainingUtilBalanceBucket2]*/, 
 NULL/*[RemainingUtilBalanceBucket3]*/, NULL/*[RemainingUtilBalanceBucket4]*/, NULL/*[RemainingUtilBalanceBucket5]*/, NULL/*[RemainingUtilBalanceBucket6]*/, ''/*[UnmeteredAcct]*/, 'N'/*[PaymentOption]*/, NULL/*[MaxDailyAmt]*/, 
 NULL/*[MeterAccessNote]*/, NULL/*[SpecialNeedsExpirationDate]*/, NULL/*[SwitchHoldStatusIndicator]*/, NULL/*[SpecialMeterConfig]*/, NULL/*[MaximumGeneration]*/, NULL/*[IgnoreRescind]*/, NULL/*[ServiceDeliveryPoint]*/, 
 NULL/*[GasCapacityAssignment]*/, NULL/*[CPAEnrollmentTypes]*/, NULL/*[DaysInArrears]*/, NULL/*[RU_Notes]*/, NULL/*[RD_SiteCharacterDate]*/, NULL/*[SupplierPricingStructureNr]*/, NULL/*[SupplierGroupNumber]*/, 
 NULL/*[IndustrialClassificationCode]*/, NULL/*[UtilityTaxExemptStatus]*/, NULL/*[AccountSettlementIndicator]*/, NULL/*[NypaDiscountIndicator]*/, NULL/*[UtilityDiscount]*/, NULL/*[IcapEffectiveDate]*/, 
 NULL/*[FutureIcapEffectiveDate]*/, NULL/*[FutureIcap]*/, NULL/*[ChangeCancellationFee]*/, NULL/*[CancellationFee]*/, NULL/*[MunicipalAggregation]*/
)
SET @ServiceKey = SCOPE_IDENTITY()

INSERT INTO daes_AccentMarket..tbl_814_Name ( [814_Key], [EntityIdType], [EntityName], [EntityName2], [EntityName3], [EntityDuns], [EntityIdCode], [Address1], [Address2], [City], [State], [PostalCode], 
 [CountryCode], [ContactCode], [ContactName], [ContactPhoneNbr1], [ContactPhoneNbr2], [ContactPhoneNbr3], [EntityFirstName], [EntityLastName], [CustType], [TaxingDistrict], [EntityMiddleName], [County], [EntityEmail])
VALUES(
 @SourceId/*[814_Key]*/, '8R'/*[EntityIdType]*/, 'OLIVIA T HARJADI'/*[EntityName]*/, NULL/*[EntityName2]*/, NULL/*[EntityName3]*/, NULL/*[EntityDuns]*/, NULL/*[EntityIdCode]*/, '7440 LA VISTA DR APT 269'/*[Address1]*/, 
 NULL/*[Address2]*/, 'DALLAS'/*[City]*/, 'TX'/*[State]*/, '752145814'/*[PostalCode]*/, NULL/*[CountryCode]*/, NULL/*[ContactCode]*/, NULL/*[ContactName]*/, NULL/*[ContactPhoneNbr1]*/, NULL/*[ContactPhoneNbr2]*/, 
...
INSERT INTO daes_AccentMarket..tbl_814_Service_Meter ( [Service_Key], [EntityIdCode], [MeterNumber], [MeterCode], [MeterType], [LoadProfile], [RateClass], [RateSubClass], [MeterCycle], [MeterCycleDayOfMonth], [SpecialNeedsIndicator], 
 ...
 [VendorAgentNumber], [VendorAbbreviation], [VendorIdNumber], [VendorOrderNumber], [PricingStructureCode], [MeterOwnerDUNS], [MeterOwner], [MeterInstallerDUNS], [MeterInstaller], [MeterReaderDUNS], [MeterReader], 
...
VALUES(
 ...
 NULL/*[StandardPointLocation]*/, NULL/*[ReportIdentification]*/, NULL/*[Supplier]*/, NULL/*[Area]*/, NULL/*[CollectorIdentification]*/, NULL/*[VendorAgentNumber]*/, NULL/*[VendorAbbreviation]*/, NULL/*[VendorIdNumber]*/, 
 NULL/*[VendorOrderNumber]*/, NULL/*[PricingStructureCode]*/, NULL/*[MeterOwnerDUNS]*/, NULL/*[MeterOwner]*/, NULL/*[MeterInstallerDUNS]*/, NULL/*[MeterInstaller]*/, NULL/*[MeterReaderDUNS]*/, NULL/*[MeterReader]*/, 
 NULL/*[MeterMaintenanceProviderDUNS]*/, NULL/*[MeterMaintenanceProvider]*/, NULL/*[MeterDataManagementAgentDUNS]*/, NULL/*[MeterDataManagementAgent]*/, NULL/*[SchedulingCoordinatorDUNS]*/, NULL/*[SchedulingCoordinator]*/, 
 NULL/*[MeterInstallPending]*/, NULL/*[PackageOption]*/, NULL/*[UsageCode]*/, NULL/*[MeterServiceVoltage]*/, NULL/*[LossFactor]*/, 'AMSR'/*[AMSIndicator]*/, 'AMSR'/*[SummaryInterval]*/, NULL/*[NextCycleRate]*/, 
 NULL/*[VariableRateIndicator]*/, NULL/*[RateTerm]*/, NULL/*[RateTermDateExpirationDate]*/
)

SET @MeterKey = SCOPE_IDENTITY()

INSERT INTO daes_AccentMarket..tbl_814_Service_Meter_Type ([Meter_Key], [MeterMultiplier], [MeterType], [ProductType], [TimeOfUse], [NumberOfDials], [UnmeteredNumberOfDevices], [UnmeteredDescription], [StartMeterRead], 
 [EndMeterRead], [ChangeReason], [TimeOfUse2])
VALUES (
  @MeterKey/*[Meter_Key]*/, 1/*[MeterMultiplier]*/, 'KHMON'/*[MeterType]*/, NULL/*[ProductType]*/, 51/*[TimeOfUse]*/, '5.0'/*[NumberOfDials]*/, NULL/*[UnmeteredNumberOfDevices]*/, NULL/*[UnmeteredDescription]*/, 
 NULL/*[StartMeterRead]*/, NULL/*[EndMeterRead]*/, NULL/*[ChangeReason]*/, NULL/*[TimeOfUse2]*/
)

INSERT INTO daes_Accent..CustomerTransactionRequest 
( [UserID], [CustID], [PremID], [TransactionType], [ActionCode], [TransactionDate], [Direction], [RequestDate], [ServiceActionCode], [ServiceAction], [StatusCode], [StatusReason], [SourceID], [TransactionNumber], 
...
";
        ...
        private static void EnrollCustomers()
        {
             var maintenance = new MyMaintenance(_appConfig.ConnectionCsr, _appConfig.ConnectionMarket, _clientConfig.ConnectionBillingAdmin);
            maintenance.EnrollCustomers();
        }
